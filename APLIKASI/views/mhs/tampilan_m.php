					...
					<table class="table table-bordered">
						...
						<?php foreach ($SYARAT_DAFTAR['SYARAT'] as $s): ?>
							<tr>
								...
								<td style="vertical-align: middle; text-align: center;"> Petugas Fakultas</td>
					...
					<?php for($j=0; $j < $jml_data; $j++){ ?>
						<?php if($j==0){ ?>
							<tr>
								...
								<td rowspan="<?php echo $jml_data; ?>" style="text-align: center; vertical-align: middle;"><span class="badge badge-info"><i class="icon-white icon-info"></i></span></td>
							</tr>
						<?php }else{ ?>
							<tr>
								<td><?php echo ($KEGIATAN[2][$i][$j]['IDN']=='')?'-':$KEGIATAN[2][$i][$j]['IDN']; ?></td>
